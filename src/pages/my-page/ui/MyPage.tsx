    ...
    >
      <div className="px-5 flex gap-3.5 items-center mt-6">
        ...
        <div className="flex flex-col items-start">
          ...
          <span className="text-sm font-medium tracking-[-0.5px] text-[#585858]">
            기본 정보 보기
          </span>
        </div>
      </div>
      ...
      <div className="rounded-t-[30px] bg-white shadow-[0px_-1px_2px_0px_#CECBE8] px-5 pt-6 mt-6 flex-1 divide-y divide-[#F1F2F4]">
        <div className="py-3 h-16 text-lg tracking-[-0.45px] text-left flex items-center justify-between">
          내 프로필 카드
        </div>
        <div className="py-3 h-16 text-lg tracking-[-0.45px] text-left flex items-center justify-between">
          설정
        </div>
        <div className="py-3 h-16 text-lg tracking-[-0.45px] flex items-center justify-between">
          <span>공지사항/이벤트</span>
