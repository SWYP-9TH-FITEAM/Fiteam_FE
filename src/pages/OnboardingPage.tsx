  ...
  return (
    <LayoutMo hasHeader={true}>
      <div className="flex flex-col justify-between h-full ">
        ...
        <Button className="w-full flex h-[54px] mb-[114px] justify-center items-center gap-2.5 shrink-0 px-[132px] py-[13px] rounded-[10px] bg-[#E9E9E9] text-black text-xl font-medium hover:bg-[#c9c9c9]">
          시작하기
        </Button>
      </div>
    </LayoutMo>
